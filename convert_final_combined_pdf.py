#!/usr/bin/env python3
"""
Convert Markdown resume to final combined PDF
Combines: 3号's strict single-page layout with 4号's skill design
"""
...
def convert_md_to_html(md_file):
    """Convert Markdown file to HTML with combined design"""
    ...
    # Create full HTML document with combined design
...
<head>
    ...
    <style>
        ...
        /* Strict single-page enforcement - 3号标准 */
        .page-break-avoid {{
...
def main():
    if len(sys.argv) != 3:
        print("用法: python convert_final_combined_pdf.py <markdown文件> <pdf输出文件>")
        sys.exit(1)
