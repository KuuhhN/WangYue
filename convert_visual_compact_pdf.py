#!/usr/bin/env python3
"""
Convert Markdown resume to visual-optimized compact one-page PDF
Based on visual design but ultra-compressed for single page
"""
...
def convert_md_to_html(md_file):
    """Convert Markdown file to HTML with visual compact design"""
    ...
    # Create full HTML document with visual compact design
...
<head>
    ...
    <style>
        ...
        /* Compact Header based on visual design */
        .resume-header {{
            display: flex;
        ...
        /* Skills - Visual design block style */
        .skill-category {{
            margin-bottom: 10px;
        }}
...
def main():
    if len(sys.argv) != 3:
        print("用法: python convert_visual_compact_pdf.py <markdown文件> <pdf输出文件>")
        sys.exit(1)
